...
void showCustomDialog(BuildContext context) {
  ...
  showDialog(
    context: context,
    barrierColor:
        Colors.transparent, // Make barrier transparent for blur effect
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Image.asset(IconPath.star, width: 19.w, height: 24.h),
                    SizedBox(width: 21.w),
                    Image.asset(ImagePath.title, width: 107.w, height: 24.h),
                  ],
                ),
                          ...
                          child: GestureDetector(
                            ...
                            child: Obx(
                              () => Container(
                                ...
                                decoration: BoxDecoration(
                                  color: tapcontroller.selectedTab.value == 0
                                      ? Color(0xffFFFFFF)
                                      : Color(0xffF5F5F5),
                                  borderRadius: BorderRadius.circular(12),
                                  boxShadow: [
                          ...
                          child: GestureDetector(
                            ...
                            child: Obx(
                              () => Container(
                                ...
                                height: double.infinity,
                                decoration: BoxDecoration(
                                  color: tapcontroller.selectedTab.value == 1
                                      ? Color(0xffFFFFFF)
                                      : Color(0xffF5F5F5),
                                  borderRadius: BorderRadius.circular(12),
                                  boxShadow: [
