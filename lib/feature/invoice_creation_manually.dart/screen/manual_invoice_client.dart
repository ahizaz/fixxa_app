...
class ManualInvoiceClient extends StatelessWidget {
  const ManualInvoiceClient({super.key});

  Future<void> _pickImage(InvoiceManuallyController controller) async {
    final picker = ImagePicker();
    final pickedFile = await picker.pickImage(source: ImageSource.gallery);
    
    if (pickedFile != null) {
      controller.manualClientImage.value = pickedFile.path;
    }
  }
