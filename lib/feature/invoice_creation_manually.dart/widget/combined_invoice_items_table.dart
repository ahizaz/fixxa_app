...
import '../controller/invoice_manually_controller.dart';

class CombinedInvoiceItemsTable extends StatelessWidget {
  final InvoiceManuallyController controller;
  const CombinedInvoiceItemsTable({super.key, required this.controller});
