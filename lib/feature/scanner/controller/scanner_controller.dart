...
//           appDirectory = await getExternalStorageDirectory(); // This is typically /storage/emulated/0/Android/data/your.package.name/files
//           // For a more universally accessible "Downloads" like folder, you might need to use a different package or method,
//           // but getExternalStorageDirectory is a common starting point.
//           // For truly global Downloads, you might need `path_provider_android` or similar, but for simplicity, let's target external storage first.
//         } else if (Platform.isIOS) {
//           appDirectory = await getApplicationDocumentsDirectory(); // This is the app's document directory on iOS
//         }

//         if (appDirectory == null) {
//           Get.snackbar('Error', 'Could not get external storage directory.');
//           return;
//         }

//         // Create a custom directory within the app's external storage
//         final String customPath = '${appDirectory.path}/FrixxaPDFs';
