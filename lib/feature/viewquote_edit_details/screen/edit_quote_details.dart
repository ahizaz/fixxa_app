...
class EditQuoteDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final QuoteEditDetailsController controller = Get.put(QuoteEditDetailsController(quoteIndex));
    return Scaffold(
      ...
      onTap: controller.isFormValid
          ? () {
              ...
              final data = homeController.quoteData[controller.quoteIndex];
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CircleAvatar(
                                ...
                                child: Icon(Icons.check, color: Color(0xff4CAF50), size: 40.sp),
                              ),
